...
export const adapter_netlify_installer: Installer = ({ project_dir }) => {
	// Add dependencies to package json

	add_pkg_dependency({
		project_dir,
		dependencies: ["@sveltejs/adapter-netlify"],
	...
	const config_src = path.join(extras_dir, `config/svelte-netlify.js`);
